...
const OurPhilosophy = () => {
  return (
    <section className="bg-[#F6F6F6] py-[50px]">
      <div className="max-w-[1440px] mx-auto w-[90%] flex items-center justify-between gap-[90.54px] *:w-1/2">
        <SectionHeader
...
Our playing philosophy shapes our thoughts and actions both on and off the pitch. We aim to develop disciplined, confident, and tactically aware players who understand the game and express themselves positively."
        ...
        <div className="flex flex-col gap-[28px]">
          <div className="flex flex-col items-center rounded-2xl border-[1.44px] border-[#E8E8E8] bg-white px-[7%] justify-center py-[27.69px]">
            <p className="text-[16px] leading-[28px] font-inter text-text-color">
              Football is not just about physical ability. It is about
              intelligence, creativity, and decision-making.
            </p>
          </div>
          <div className="flex flex-col rounded-2xl border-[1.44px] border-[#E8E8E8] bg-white px-[7%] justify-center py-[27.69px]">
            <p className="text-[16px] leading-[28px] font-bold font-inter text-text-color">
              FIFA Grassroots Coaching Essentials
              <p className="text-[16px] leading-[28px] font-normal font-inter text-text-color">
