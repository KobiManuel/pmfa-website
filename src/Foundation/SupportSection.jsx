        ...
        <div className="flex-1 flex flex-col justify-center gap-8 mt-[59.83px] max-[1000px]:mt-0">
          <div className={`flex flex-col gap-[19.42px] max-[480px]:gap-3`}>
            ...
            >
              ...
              giving Nigeria's brightest young football talents the opportunity
              they deserve. The PMF Foundation is built on the belief that every
              child deserves a chance to play, grow, and dream.
            </p>
          </div>
          ...
          <div className="max-[480px]:p-4 p-[23.29px]  bg-[#F6F6F6] rounded-lg border-[0.9px] border-[#D5D5D5]">
            ...
            <p className=" font-inter text-[9.85px] leading-[16.12px] text-[#121212]">
              PMF Foundation is a registered non-profit organisation in Nigeria.
              All donations are used directly for programme delivery and impact.
        ...
        <div className=" max-[1000px]:w-full bg-[#F8F8F8] border-[0.92px] border-[#D5D5D5] rounded-[7.92px] flex flex-col p-[46px] max-[800px]:p-6">
          ...
          <div className="flex flex-col gap-3 mt-[23.36px]">
            ...
            <input
              ...
              className={`w-full px-4 py-[13px] h-[34.04px] rounded-md text-[14px] text-[#555] bg-[#ebebeb] border border-[#ebebeb] outline-none placeholder:text-[#bbb] focus:border-primary transition-all
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2 max-[480px]:flex-col">
              <input
                ...
                className="flex-1 px-4 py-[13px] min-h-[43.71px] rounded-md text-[14px] text-[#444] bg-[#ebebeb] border border-[#ebebeb] outline-none placeholder:text-[#bbb] focus:border-primary transition-all"
              />
              <input
                type="text"
          ...
          {/* Donate CTA */}
          <button className="mt-[15.16px]  h-[34.04px] w-full bg-primary border-none rounded-[7.36px] text-[12.88px] font-bold tracking-[0.12em] uppercase text-text-color cursor-pointer hover:opacity-90 transition-opacity">
